...
function file_utils.get_tail(filename)
  return vim.fn.fnamemodify(filename, ":t")
end

function file_utils.split_filename(filename)
  local nodes = {}
  for parent in string.gmatch(filename, "[^/]+/") do
    table.insert(nodes, parent)
  end
  table.insert(nodes, file_utils.get_tail(filename))
  return nodes
end

function file_utils.reverse_filename(filename)
  return reverse(file_utils.split_filename(filename))
end

function file_utils.get_unique_filename(filename, other_filenames)
  local rv = ''
  local others_reversed = vim.tbl_map(file_utils.reverse_filename, other_filenames)
  local filename_reversed = file_utils.reverse_filename(filename)
...
function file_utils.get_current_ufn()
  ...
  return file_utils.get_unique_filename(current_name, names)
end
